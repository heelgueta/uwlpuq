...
### 111 load original file, load libraries -------------------------------------
options(digits = 3);options(scipen = 999);options(max.print = 5000)
odf <- readRDS("base_humedales_final.rds")#load rds datafile
#file not provided as it contains sens info, final dataset is loaded at the end

#install and load dplyr package
#install.packages("dplyr")  # Install the package if not already installed
library(dplyr)             # Load the package

### 112 rename all columns -----------------------------------------------------
odf <- odf %>%
  rename(
    # Context variables (1-13)
    caseid = id_caso, startd = startdate, finisd = enddate, status = status,
    ipaddr = ipaddress, progrs = progress, duratn = `duration (in seconds)`,
    fnishd = finished, record = recordeddate, respid = responseid,
    loclat = locationlatitude, loclon = locationlongitude, intnam = q1.1,
    consnt = q2.1,
    
    # General and environmental views (14-45)
    genenv = a1, prchil = a2.1, prchot = a2.1_otesp, prpers = a2.2,
    prpeot = a2.2_otesp,
    envec1 = a2.3_1, envec2 = a2.3_2, envec3 = a2.3_3, envec4 = a2.3_4,
    envec5 = a2.3_5, envec6 = a2.3_6,
    natcn1 = a3.1_1, natcn2 = a3.1_2, natcn3 = a3.1_3, natcn4 = a3.1_4,
    envpa1 = a3.2_1, envpa2 = a3.2_2, envpa3 = a3.2_3, envpa4 = a3.2_4,
    envpa5 = a3.2_5, envpa6 = a3.2_6, envpa7 = a3.2_7,
    govrol = a.4,
    penvb1 = a.5.1_1, penvb2 = a.5.1_2, penvb3 = a.5.1_3, penvb4 = a.5.1_4,
    penvb5 = a.5.1_5, penvb6 = a.5.1_6,
    pecsa1 = a5.2_1, pecsa2 = a5.2_2, pecsa3 = a5.2_3, 
    
    # Wetlands knowledge and opinions (46-109)
    wlknw1 = b1.1_1, wlknw2 = b1.1_2, wlknw3 = b1.1_3, wlknw4 = b1.1_4,
    wlknw5 = b1.1_5, wlknw6 = b1.1_6, wlknw7 = b1.1_7, wlknot = b1.1_otesp,
    wlim01 = b1.2_1, wlim02 = b1.2_2, wlim03 = b1.2_3, wlim04 = b1.2_4,
    wlim05 = b1.2_5, wlim06 = b1.2_6, wlim07 = b1.2_7, wlim08 = b1.2_8,
    wlim09 = b1.2_9, wlim10 = b1.2_10, wlim11 = b1.2_11, wlim12 = b1.2_12,
    wlim13 = b1.2_14, wlim14 = b1.2_15, wlim15 = b1.2_13,
    wlan01 = b1.3_1, wlan02 = b1.3_2, wlan03 = b1.3_3, wlan04 = b1.3_4,
    wlan05 = b1.3_8, wlan06 = b1.3_5, wlan07 = b1.3_9, wlan08 = b1.3_10,
    wlan09 = b1.3_11, wlan10 = b1.3_12, wlan11 = b1.3_6, wlan12 = b1.3_7,
    wlanot = b1.3_otesp,
    wlpl01 = b1.4_1, wlpl02 = b1.4_2, wlpl03 = b1.4_3, wlpl04 = b1.4_4,
    wlpl05 = b1.4_5, wlpl06 = b1.4_6, wlpl07 = b1.4_7, wlplot = b1.4_otesp,
    wlth01 = b1.5_1, wlth02 = b1.5_2, wlth03 = b1.5_3, wlth04 = b1.5_4,
    wlth05 = b1.5_5, wlth06 = b1.5_7, wlth07 = b1.5_8, wlth08 = b1.5_10,
    wlth09 = b1.5_11, wlth10 = b1.5_12, wlth11 = b1.5_13, wlth12 = b1.5_6,
    wlth13 = b1.5_9, wlth14 = b1.5_14, wlthot = b1.5_otesp,
    wlpri1 = b1.6_1, wlpri2 = b1.6_2, wlpri3 = b1.6_3, wlpri4 = b1.6_4,
    wlrspn = b1.7,
    
    # Parque Maria Behety (110-152)
    mbfreq = b2.1, mbleng = b2.2,
    mbac01 = b2.3_1, mbac02 = b2.3_2, mbac03 = b2.3_3, mbac04 = b2.3_4,
    mbac05 = b2.3_5, mbac06 = b2.3_6, mbac07 = b2.3_7, mbac08 = b2.3_8,
    mbac09 = b2.3_9, mbacot = b2.3_otesp,
    mbtran = b2.4, mbtrot = b2.4_otesp, mbaccs = b2.5, mbstat = b2.6,
    mbbe01 = b2.7_1, mbbe02 = b2.7_2, mbbe03 = b2.7_3, mbbe04 = b2.7_4,
    mbbe05 = b2.7_5, mbbe06 = b2.7_6, mbbe07 = b2.7_7, mbbe08 = b2.7_8,
    mbbe09 = b2.7_9, mbbe10 = b2.7_10, mbbe11 = b2.7_11, mbbe12 = b2.7_12,
    mbbe13 = b2.7_13, mbbe14 = b2.7_14, mbbemi = b2.8,
    mbpr01 = b2.9_1, mbpr02 = b2.9_2, mbpr03 = b2.9_3, mbpr04 = b2.9_4,
    mbpr05 = b2.9_5, mbpr06 = b2.9_6, mbpr07 = b2.9_8, mbpr08 = b2.9_7,
    mbprot = b2.9_otesp, mblvis = b2.10, mbnvis = b2.11, mbnvot = b2.11_otesp,
    
    # Humedal Tres Puentes (153-197)
    tpfreq = b3.1, mbleng = b3.2,
    tpac01 = b3.3_1, mbac02 = b3.3_2, mbac03 = b3.3_3, mbac04 = b3.3_4,
    tpac05 = b3.3_5, mbac06 = b3.3_6, mbac07 = b3.3_7, mbac08 = b3.3_8,
    tpac09 = b3.3_9, mbacot = b3.3_otesp,
    tptran = b3.4, mbtrot = b3.4_otesp, mbaccs = b3.5, mbstat = b3.6,
    tpbe01 = b3.7_1, mbbe02 = b3.7_2, mbbe03 = b3.7_3, mbbe04 = b3.7_4,
    tpbe05 = b3.7_5, mbbe06 = b3.7_6, mbbe07 = b3.7_7, mbbe08 = b3.7_8,
    tpbe09 = b3.7_9, mbbe10 = b3.7_10, mbbe11 = b3.7_11, mbbe12 = b3.7_12,
    tpbe13 = b3.7_13, mbbe14 = b3.7_14, mbbemi = b3.8,
    tppr01 = b3.9_1, mbpr02 = b3.9_2, mbpr03 = b3.9_3, mbpr04 = b3.9_4,
    tppr05 = b3.9_5, mbpr06 = b3.9_6, mbpr07 = b3.9_8, mbpr08 = b3.9_7,
    tpprot = b3.9_otesp, mblvis = b3.10, mbnvis = b3.11, mbnvot = b3.11_otesp,
    
    # Behavior intentions (198-207)  
    bint01 = b4.1_1, bint02 = b4.1_2, bint03 = b4.1_3, bint04 = b4.1_4,
    bint05 = b4.1_5, bint06 = b4.1_6, bint07 = b4.1_7, bint08 = b4.1_8,
    bint09 = b4.1_9, bint10 = b4.1_10,
    
    # Regional social identification (208-211)
    regid1 = c1.1_1, regid2 = c1.1_2, regid3 = c1.1_3, regid4 = c1.1_4,    
    # Place attachment (212-215)
    place1 = c1.2_1, place2 = c1.2_2, place3 = c1.2_3, place4 = c1.2_4,
    
    # Background/demographic variables (216-234)
    nation = c2.1, natiot = c2.1_ot, bplace = c2.2, bplaot = c2.2_ot,
    ethnic = c2.3, ethnot = c2.3_ot, educat = d1, emplst = d2, occupa = d3,
    srvstd = fecha_inicio, srvend = fecha_final, intna2 = encuestador,
    gender = genero, agepar = edad, phonen = telefono, addrss = direccion,
    sexpar = sexo, agegrp = edad2, educar = educacion_rec,
    
    # Weighting (235)  
    weight = pond #weighting factor
  )

### 113 recode most vars to make then numeric ----------------------------------
#fixing intnam
...
odf$mblvis <- ifelse(is.na(odf$mblvis), 0, odf$mblvis)
odf$tplvis <- ifelse(is.na(odf$tplvis), 0, odf$tplvis)
...
# Recode odf$educar as a numerical variable
...
### 114 remove vars and reorder columns ----------------------------------------
...
### 115 save def version of "odf" (original datasframe) as file and load it ----
saveRDS(odf, "uwlpuq.rds") #this file is provided so code can be run from here
odf <- readRDS("uwlpuq.rds") #this will be used whenever we need to go back

### 116 impute missing data with mice, save as "idf"  --------------------------
...
#imputed_data <- mice(odf, m = 10, maxit = 10, method = 'pmm', seed = 225)
#disabled as it can take very long time to run
#saveRDS(imputed_data, file = "imputed_data.rds") (in case it is needed)
...
### 117 overall cleanup (remove objects and libraries)  ------------------------

rm(list = setdiff(ls(), c("odf","idf")))  # Remove all objects except 'odf' & 'idf'
...
#odf is the original data, re-arranged, re-ordered, sensible-redundant vars out
