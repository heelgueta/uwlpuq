cfawiz <- function(data, scale_spec, ordered = TRUE, 
  ...
  # 4. Handle multiple scale specifications
  ...
  # 5. Handle estimator specification
  ...
  # 6. Helper function for p-value formatting
  ...
  # 7. Helper function for color gradient
  ...
  # 8. Helper function to truncate estimator names
  ...
  # 9. Helper function for color coding fit indices
  ...
  # 10. Load variable descriptions if provided
  ...
  # 11. Function to run CFA for a single specification with multiple estimators
  ...
  # 12. Run CFA for each specification
  all_results <- lapply(scale_spec, run_single_cfa_multi)
  
  # 13. Process and print results for each specification
